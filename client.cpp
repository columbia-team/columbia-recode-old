...
void Client::DrawHUD() {
	...
	std::string text = tfm::format(XOR("columbia <%n> | fps: %i | ms: %i | rate: %i | %H:%M:%S |"), g_cl.m_user, fps, ms, rate, time.str());
