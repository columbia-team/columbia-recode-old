...
public:
	void init() {
		...
		minimal_damage.setup(XOR("minimal damage"), XOR("minimal_damage"), 1.f, 130.f, true, 0, 40.f, 1.f);
		...
		penetrate_minimal_damage.setup("", XOR("penetrate_minimal_damage"), 1.f, 130.f, false, 0, 30.f, 1.f);
...
public:
	void init() {
		...
		SetClanTag.setup(XOR("clan tag spammer"), XOR("SetClanTag"));
		RegisterElement(&SetClanTag, 1);
